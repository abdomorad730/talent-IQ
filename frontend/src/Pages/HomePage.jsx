...
function HomePage() {
  return (
    <div className="bg-gradient-to-br from-base-100 to-base-300 via-base-200">
      {/* Navbar */}
      <nav className=" bg-base-100/80 backdrop-blur-md border-b border-primary/20 shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          ...
          <SignInButton mode="modal">
            <button className="group px-6 py-3 bg-gradient-to-r from-primary to-secondary text-white rounded-xl
           shadow-lg hover:shadow-xl transition-all duration-200 text-sm font-semibold
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-base-content/70 max-w-xl leading-relaxed ">
              ...
              Connect face-to face, code in real-time, and ace your technical interview.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button to="/about" className="btn btn-outline btn-lg">
            ...
            <div className="stats stats-vertical lg:stats-horizontal shadow-lg bg-base-100">
              ...
              <div className="stat">
                ...
                <div className="stat-title">Sessions Created</div>
              </div>
              <div className="stat">
          ...
          {/* Right Content */}
          <img src="/hero.png" alt="Hero Image" className="rounded-3xl shadow-2xl w-full border-4 border-base-100 
